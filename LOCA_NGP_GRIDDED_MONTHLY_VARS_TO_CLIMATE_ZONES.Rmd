...
# Plot Zones
    ...
    ggplot(data = climate_regions_table) +
      aes(x    = lon,
          y    = lat) +
      theme_bw() +
      ...
      ylab(label = "Latitude") +
      labs(title = "US Climate and CAN Weather Regions")+
      scale_fill_discrete(guide = FALSE)+
      geom_raster(data    = climate_regions_table,
                  mapping = aes(x     = lon,
                                y     = lat,
                                fill  = Climate_Zone))+
...
for (ens in ensembles) {
  ...
  loca_climate_zone_stats$Time = as.POSIXct(loca_climate_zone_stats$Time)
