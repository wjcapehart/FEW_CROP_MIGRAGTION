...
```{r}
  ...
  root_url = "/maelstrom2/LOCA_GRIDDED_ENSEMBLES/LOCA_NGP/climatology/MONTHLY/tasmin/"

  file_url = str_c(root_url,
                   "LOCA_NGP_tasmin_allensembles_allscenarios_30Y_MEAN_MONTHLY_MIN_1951-2095.RData",
                   str_c = "")
